...
Kita menggunakan Tabs ketika data atau informasi yang akan ditampilkan sudah cukup banyak dan bisa dikelompokkan secara logis ke dalam beberapa kategori. Jika kita tetap menggunakan Section untuk data yang banyak, semua informasi tersebut akan tampil sekaligus di satu halaman, sehingga memaksa pengguna untuk melakukan scroll panjang ke bawah. Tabs menggantikan keharusan scroll panjang tersebut dengan navigasi klik yang terpisah per kategori. <br>
**2. Apa kelebihan Tabs untuk data panjang?** <br>
Kelebihannya adalah: <br>
-> Mengurangi scrolling panjang yang melelahkan.<br>
-> Membuat tampilan antarmuka (UI) terlihat jauh lebih ringkas, rapi, dan profesional. <br>
-> Secara keseluruhan, meningkatkan kenyamanan atau user experience dari pengguna aplikasi. <br>
**3. Apakah Tabs bisa digunakan pada Form juga?** <br>
Ya, sangat bisa. Meskipun fokus pada Jobsheet 9 ini adalah penerapan Tabs pada Info List (halaman tampilan data/View Page) , komponen Tabs di Filament juga secara luas digunakan pada halaman Form (Create atau Edit). Penggunaan Tabs pada form sangat membantu memecah isian data yang terlalu panjang agar proses data entry tidak terasa mengintimidasi. <br>
**4. Bagaimana jika tab terlalu banyak?** <br>
Jika jumlah tab yang dibuat terlalu banyak, menampilkannya secara horizontal dapat membuat layar penuh atau teks pada tab terpotong. Solusinya adalah dengan mengubah orientasi tab tersebut menjadi vertikal. Di dalam Filament, kamu hanya perlu menambahkan method ->vertical() pada komponen Tabs. Dengan begitu, menu tab akan otomatis tersusun dengan rapi ke bawah di sisi sebelah kiri konten utama.
</blockquote>
</details>